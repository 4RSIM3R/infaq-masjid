...
<body class="h-screen w-full bg-white">
    ...
    <div class="h-screen mx-auto w-full max-w-sm lg:w-96 p-4 flex flex-col justify-center">
        ...
        <div class="my-2">
            <form action="{{ route('register.store') }}" method="POST" class="space-y-6" autocomplete="off">
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <input id="name" autocomplete="off" name="name" type="text" required
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <input id="email" autocomplete="off" name="email" type="email" required
                            class="block w-full rounded-md border-0 py-1.5 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-teal-600 sm:text-sm sm:leading-6">
                        @error('email')
                            <p class="mt-1 text-xs italic text-red-600">{{ $message }}</p>
                        @enderror
        ...
        <span class="text-center">
            Sudah punya akun? <a href="{{ route('login.form') }}" class="text-teal-600 hover:text-teal-500">Masuk
                disini</a>
        </span>
